...
CREATE TABLE `patient_billing` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `patient_billing_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
INSERT INTO `patient_billing` VALUES (1,'U1',50.00,0.00,'pending',NULL,NULL,'2024-05-07 00:32:12'),(2,'U1',100.00,0.00,'pending',NULL,NULL,'2024-05-07 00:32:36'),(3,'U1',60.00,60.00,'paid',NULL,NULL,'2024-05-07 00:43:12');
...
/*!50003 DROP PROCEDURE IF EXISTS `get_patient_balance` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `select_patient_billing_by_user_id` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
-- Dump completed on 2024-05-07 14:57:27
